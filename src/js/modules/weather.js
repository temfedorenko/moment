...
const getWeatherData = () => {
  ...
  const weatherTranslation = {
    ...
    ua: {
      weatherError:
        "Місто не знайдемо, спробуйте, будь ласка, вказати найближче до вас місто",
  ...
  async function getWeather() {
    ...
    if (!response.ok) {
      weatherError.textContent =
        language === "en"
          ? weatherTranslation.en.weatherError
          : weatherTranslation.ua.weatherError;
